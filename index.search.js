var relearn_search_index = [
  ...
  {
    "content": "Table of contents soiap_Si8_RS ",
    "description": "",
    "tags": null,
    "title": "Examples",
  ...
  {
    "content": "Version information Table of contents Version 1.0.0 Version 0.10.3 or earlier ",
    "description": "",
    "tags": null,
  ...
  {
    "content": "CrySPY CrySPY 1.0.0 or later can be installed by pip.\npip install csp-cryspy The executable script, cryspy, is automatically installed in your PATH. You can check by\nwhich cryspy cal_fingerprint (optional) cal_fingerprint is a program to calculate structure descriptors and is required if algo is BO. From CrySPY 1.0.0, the cal_fingerprint program is included in CrySPY utility. See Instllation/CrySPY_utility/Compile cal_fingerprint for compilation.\nPut the executable file of cal_fingerprint in your PATH. Or, specify the path of the executable file in cryspy.in as follows:\n[BO] fppath = /xxx/xxx/xxx/cal_fingerprint ",
    "description": "",
    "tags": null,
  ...
  {
    "content": "Script to convert structre data into init_struc_data.pkl. The default input format is init_POSCARS. Single structure data such as POSCAR and cif files can be optionally converted. Output is init_struc_data.pkl. Structure data can be added to an already existing init_struc_data.pkl. The structure ID is not taken into account and is newly assigned. If the number of atoms is different, an error is generated.\ninit_struc_data.pkl can be loaded at the start of the simulation in CrySPY.\nUsage usage: pos2pkl.py [-h] [-s [SINGLE ...]] [infile ...] positional arguments: infile input file: init_POSCARS optional arguments: -h, --help show this help message and exit -s [SINGLE ...], --single [SINGLE ...] input file: single structure file (POSCAR, cif) Examples init_POSCARS –\u003e init_struc_data.pkl It can be used to convert init_POSCARS generated by CrySPY to init_struc_data.pkl in another machine such as a supercomputer. Multiple input files can be converted.\n$ python3 pos2pkl.py init_POSCARS Converted. The number of structures: 4 Save init_struc_data.pkl Multiple inputs:\n$ python3 pos2pkl.py init_POSCARS init_POSCARS2 init_POSCARS3 Converted. The number of structures: 12 Save init_struc_data.pkl If init_struc_data.pkl already exists in the current directory and you want to append to it:\n$ python3 pos2pkl.py init_POSCARS init_struc_data.pkl already exists. Append to init_struc_data.pkl? [y/n]: y Load init_struc_data. The number of structures: 12 Converted. The number of structures: 16 Save init_struc_data.pkl POSCAR or cif –\u003e init_struc_data.pkl Single structure data such as POSCAR and cif files can also be converted. -s/--single option is required.\n$ python3 pos2pkl.py -s POSCAR test.cif Converted. The number of structures: 2 Save init_struc_data.pkl init_POSCARS, POSCAR –\u003e init_struc_data.pkl $ python3 pos2pkl.py init_POSCARS -s POSCAR Converted. The number of structures: 5 Save init_struc_data.pkl Warning The following is wrong. The init_POSCARS is also treated as a single structure.\n$ python3 pos2pkl.py -s POSCAR init_POSCARS ",
    "description": "",
    "tags": null,
    "title": "pos2pkl.py",
    "uri": "/cryspy_utility/pos2pkl/index.html"
  },
  {
  ...
  {
    "content": "Structure optimizer At least one optimizer is required.\nFirst-principles calculation VASP QUANTUM ESPRESSO OpenMX (CrySPY 0.9.0 or later) Interatomic potential soiap LAMMPS ",
    "description": "",
    "tags": null,
  ...
  {
    "content": "CrySPY is interfaced with several structure optimizers:\nFirst-principles calculation VASP Quantum Espresso OpenMX (CrySPY 0.9.0 or later) Interatomic potential soiap LAMMPS At least one optimizer is required.\n",
    "description": "",
    "tags": null,
    "title": "Interface",
  ...
  {
    "content": "Tutorial Table of contents Random Search (RS) soiap in your local PC VASP QE OpenMX LAMMPS External program Check cryspy.in Script to run Firsrt run Submit job Check results Append structures Analysis and visualization Load external data Evolutionary Algorithm (EA) Bayesian Optimization (BO) LAQA Restriction on interatomic distances Molecular crystal structure prediction ",
    "description": "",
    "tags": null,
    "title": "Tutorial",
  ...
  {
    "content": "Features Table of contents Backup Clean CrySPY_ID in job files ",
    "description": "",
    "tags": null,
    "title": "Features",
  ...
  {
    "content": "Input file Description of the input file, cryspy.in.\nTable of contents File format [basic] section [structure] section [VASP] section [QE] section [OMX] section [soaip] section [LAMMPS] section [EA] section [BO] section [LAQA] section [option] section ",
    "description": "",
    "tags": null,
    "title": "Input file",
  ...
  {
    "content": "CrySPY Utility See Installation/CrySPY utility to download.\nTable of contents Examples soiap_Si8_RS extract_struc.py pos2pkl.py kpt_check.py ",
    "description": "",
    "tags": null,
  ...
  },
  {
    ...
    "tags": null,
    "title": "kpt_check.py",
    "uri": "/cryspy_utility/kpt_check/index.html"
  },
  {
  ...
  {
    "content": "[LAQA] section is required only if you use LAQA (algo = LAQA)\nName Value Default Description nselect_laqa int The number of structures to be selected at once. weight_laqa float 1.0 Weight of bias in the score. ",
    "description": "",
    "tags": null,
    "title": "[LAQA] section",
  ...
  {
    "content": "Download the data It is assumed here that you analyze and visualize CrySPY data in your local PC. If you use CrySPY in super computers or workstations, download the data in your local PC. You can delete the work directory if you do not need it because the file size could be very large.\njupyter notebook Move to the data/ directory in results you just download. Then copy cryspy_analyzer_RS.ipynb from CrySPY utility.\n$ ls backup/ calc_in/ cryspy.in cryspy.stat data/ err_cryspy log_cryspy $ cd data $ ls cryspy_rslt cryspy_rslt_energy_asc init_POSCARS opt_CIFS.cif opt_POSCARS pkl_data/ cp /path/to/CrySPY_utility/cryspy_analyzer_RS.ipynb . Run jupyter. (VScode, jupyter lab, jupyter notebook, and so on.) You can get the following figure by simply running the steps in order.\n",
    "description": "",
    "tags": null,
