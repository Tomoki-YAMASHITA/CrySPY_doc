var relearn_search_index = [
  ...
  {
    "content": "Table of contents soiap_Si8_RS soiap_Si8_RS_mindist qe_Si8_RS qe_benzene_2_RS_mol ",
    "description": "",
    "tags": null,
    "title": "Examples",
  ...
  {
    "content": "Tutorial Info You can find examaple files in cryspy_utility/examples.\nTable of contents Random Search (RS) soiap in your local PC VASP QE OpenMX LAMMPS External program Check cryspy.in Script to run Firsrt run Submit job Check results Append structures Analysis and visualization Load external data Evolutionary Algorithm (EA) Bayesian Optimization (BO) LAQA Molecular crystal structure prediction ",
    "description": "",
    "tags": null,
    "title": "Tutorial",
  ...
  {
    "content": "Features Table of contents Backup Clean Restriction on interatomic distances CrySPY_ID in job files ",
    "description": "",
    "tags": null,
    "title": "Features",
  ...
  {
    "content": "CrySPY Utility See Installation/CrySPY utility to download. The examples can also be downloaded from this document site.\nTable of contents Examples soiap_Si8_RS soiap_Si8_RS_mindist qe_Si8_RS qe_benzene_2_RS_mol extract_struc.py pos2pkl.py kpt_check.py ",
    "description": "",
    "tags": null,
